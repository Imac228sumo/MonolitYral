				...
				<div className={styles.modal_container}>
							...
							<FormControlLabel
								...
								label={
									<>
										...
										<Link href='/policy'>обработкой персональных данных</Link>
									</>
								}
							/>
						</FormControl>
					...
					<div className={styles.modal_footer}>
						<LoadingButton
							...
							disabled={isErrorEmail || !isAgreeable}
							onClick={handleSendMessage}
							loading={isLoading}
							loadingPosition='center'
							variant='contained'
							className={cn(styles.send_button, {
								[styles.active]: !isErrorEmail && isAgreeable,
